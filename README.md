To run this application, open the folder in IntelliJ and run the NaluriApplication.java. Remember to also connect the backend to a postgres database and
